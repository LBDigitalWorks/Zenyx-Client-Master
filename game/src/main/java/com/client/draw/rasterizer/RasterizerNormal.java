...
public class RasterizerNormal extends AbstractRasterizer {
    ...
    public void drawAlphaBlendedGraphics(float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8, float var9, int var10, int var11, int var12) {
        ...
        if (var28 != 0) {
            ...
            int[] var31 = super.clips.Rasterizer3D_rowOffsets;
            int var32 = super.clips.clipY;
    ...
    public  void vmethod6189(float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8, float var9, int var10) {
        ...
        int[] var20 = super.clips.Rasterizer3D_rowOffsets;
        int var21 = super.clips.clipY;
    ...
    public  void drawGradientTriangle(float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8, float var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int var18, int var19, int var20, int var21, int var22) {
        ...
        int var24;
        if (var23 == null) {
            var24 = super.clips.Rasterizer3D_textureLoader.getAverageTextureRGB(var22);
            ...
            if (var39 != 0) {
                ...
                int var42 = super.clips.viewportZoom;
                var14 = var13 - var14;
                var17 = var16 - var17;
                var20 = var19 - var20;
                var15 -= var13;
                ...
                int[] var52 = super.clips.Rasterizer3D_rowOffsets;
                int var53 = super.clips.clipY;
                int var54;
                if (var27 <= var28 && var27 <= var29) {
                    if (var27 < var53) {
                        ...
                        if (var28 < var29) {
                            ...
                            var54 = var27 - super.clips.centerY;
                            var43 += var45 * var54;
                            var46 += var48 * var54;
                            var49 += var51 * var54;
                    ...
                    if (var28 < var53) {
                        ...
                        if (var29 < var27) {
                            ...
                            var54 = var28 - super.clips.centerY;
                            var43 += var45 * var54;
                            var46 += var48 * var54;
                            var49 += var51 * var54;
                    ...
                    if (var27 < var28) {
                        ...
                        var54 = var29 - super.clips.centerY;
                        var43 += var45 * var54;
                        var46 += var48 * var54;
                        var49 += var51 * var54;
                        if (var37 < var38) {
        ...
        if (var5 < var6) {
            ...
            if (super.clips.rasterGouraudLowRes) {
                ...
                if (super.clips.currentFaceAlpha == 0) {
                    ...
                    var9 = super.clips.currentFaceAlpha;
                    var10 = 256 - super.clips.currentFaceAlpha;
                    if (var4 > 0) {
                        do {
    ...
    void applyColorFilterToPixelsInRange(int[] var1, int var2, int var3, int var4, int var5, int var6) {
        ...
        if (var5 < var6) {
            ...
            var4 = var6 - var5 >> 2;
            if (super.clips.currentFaceAlpha != 0) {
                if (super.clips.currentFaceAlpha == 254) {
                    while (true) {
                        --var4;
                        if (var4 < 0) {
                            var4 = var6 - var5 & 3;
                    ...
                    int var7 = super.clips.currentFaceAlpha;
                    int var8 = 256 - super.clips.currentFaceAlpha;
    ...
    void processPixelsToArray(int[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15) {
        ...
        if (var6 < var7) {
            ...
            var8 += var9 * var6;
            int var18 = var7 - var6;
            int var24 = var6 - super.clips.centerX;
            var10 += (var13 >> 3) * var24;
            var11 += var24 * (var14 >> 3);
            var12 += (var15 >> 3) * var24;
            int var23 = var12 >> 14;
            ...
            if (super.isLowDetail) {
                if (super.clips.currentFaceAlpha == 0) {
                    ...
                    var25 = super.clips.currentFaceAlpha;
                    var26 = 256 - super.clips.currentFaceAlpha;
                    var27 = var16 * var26 >> 8;
                    if (var18 > 0) {
                        do {
                            var4 = var2[(var3 & 16256) + (var3 >>> 25)];
