...
public class RasterizerDepth extends AbstractRasterizer {

    public RasterizerDepth(Clips var1) {
        super(var1);
    }

    public boolean vmethod6185() {
        return true;
    }


    public  void drawAlphaBlendedGraphics(float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8, float var9, int var10, int var11, int var12) {
        ...
        if (var23 != 0.0F) {
            ...
            if (var35 != 0.0F) {
                ...
                int[] var43 = super.clips.Rasterizer3D_rowOffsets;
                int var44 = super.clips.clipY;
                int var45;
    ...
    public void vmethod6189(float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8, float var9, int var10) {
        ...
        if (var25 != 0.0F) {
            ...
            int[] var33 = super.clips.Rasterizer3D_rowOffsets;
            int var34 = super.clips.clipY;
            int var35;
    ...
    public void drawGradientTriangle(float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8, float var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int var18, int var19, int var20, int var21, int var22) {
        int[] var23 = super.clips.Rasterizer3D_textureLoader.getTexturePixels(var22);
        if (var23 == null) {
            int var65 = super.clips.Rasterizer3D_textureLoader.getAverageTextureRGB(var22);
            ...
            super.isLowDetail = super.clips.Rasterizer3D_textureLoader.isLowDetail(var22);
            ...
            if (var34 != 0.0F) {
                ...
                if (var43 != 0.0F) {
                    ...
                    int var51 = super.clips.viewportZoom;
                    var14 = var13 - var14;
                    var17 = var16 - var17;
                    var20 = var19 - var20;
                    var15 -= var13;
                    ...
                    int[] var61 = super.clips.Rasterizer3D_rowOffsets;
                    int var62 = super.clips.clipY;
                    int var63;
                    int var64;
                    if (var27 <= var28 && var27 <= var29) {
                        if (var27 < (float)var62) {
                            ...
                            if (var28 < var29) {
                                ...
                                var63 = (int)var27 - super.clips.centerY;
                                var52 += var54 * var63;
                                var55 += var57 * var63;
                                var58 += var60 * var63;
                        ...
                        if (var28 < (float)var62) {
                            ...
                            if (var29 < var27) {
                                ...
                                var63 = (int)var28 - super.clips.centerY;
                                var52 += var54 * var63;
                                var55 += var57 * var63;
                                var58 += var60 * var63;
                        ...
                        if (var27 < var28) {
                            ...
                            var63 = (int)var29 - super.clips.centerY;
                            var52 += var54 * var63;
                            var55 += var57 * var63;
                            var58 += var60 * var63;
                            var29 = (float)((int)(var29 + 0.5F));
    ...
    public void textureMapPolygons(float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8, float var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int var18, int var19, int var20, int var21, int var22) {
        int[] var23 = super.clips.Rasterizer3D_textureLoader.getTexturePixels(var22);
        if (var23 == null) {
            int var65 = super.clips.Rasterizer3D_textureLoader.getAverageTextureRGB(var22);
            this.drawAlphaBlendedGraphics(var1, var2, var3, var4, var5, var6, var7, var8, var9, AbstractRasterizer.method5497(var65, var10), AbstractRasterizer.method5497(var65, var11), AbstractRasterizer.method5497(var65, var12));
    ...
    final void method6239(int[] var1, float[] var2, int var3, int var4, float var5, int var6) {
        int var7 = super.clips.field3142 & var6;
        int var8 = super.clips.field3139 & var6;
    ...
    final void method6177(int[] var1, float[] var2, int[] var3, int var4, int var5, int var6, int var7, float var8) {
        ...
        int var11 = super.clips.field3142 & method6175(var2[var4], var8);
    ...
    final void method6182(int[] var1, float[] var2, int var3, int var4, float var5) {
        this.method6239(var1, var2, var3, super.hslToRgb[var4], var5, method6175(var2[var3], var5));
    }
    ...
    final void method6184(int[] var1, float[] var2, int var3, int var4, int var5, int var6, float var7) {
        ...
        int var10 = super.clips.field3142 & method6175(var2[var3], var7);
    ...
    final void method6188(int[] var1, int var2, int var3, int var4, int var5, int var6, float var7, float var8, float var9, float var10) {
        ...
        if (var5 < var6) {
            ...
            if (super.clips.rasterGouraudLowRes) {
                var4 = var6 - var5 >> 2;
                var8 *= 4.0F;
                if (super.clips.currentFaceAlpha == 0) {
                    if (var4 > 0) {
                        do {
                    ...
                    var11 = super.clips.currentFaceAlpha;
                    var12 = 256 - super.clips.currentFaceAlpha;
                    int var13;
                    if (var4 > 0) {
                        do {
    ...
    final void copyPixelsWithAlphaBlending(int[] var1, int var2, int var3, int var4, int var5, int var6, float var7, float var8) {
        ...
        if (var5 < var6) {
            ...
            } else if (super.clips.currentFaceAlpha != 254) {
                int var9 = super.clips.currentFaceAlpha;
                int var10 = 256 - super.clips.currentFaceAlpha;
            ...
            } else if (var5 != 0 && var6 <= super.clips.clipX - 1) {
                while (true) {
                    --var4;
                    if (var4 < 0) {
                        var4 = var6 - var5 & 3;
    ...
    final void method6192(int[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, float var10, float var11, int var12, int var13, int var14, int var15, int var16, int var17) {
        ...
        if (var6 < var7) {
            ...
            int var20 = var7 - var6;
            int var26 = var6 - super.clips.centerX;
            var12 += (var15 >> 3) * var26;
            var13 += var26 * (var16 >> 3);
            var14 += var26 * (var17 >> 3);
            int var25 = var14 >> 14;
            ...
            if (super.isLowDetail) {
                if (super.clips.currentFaceAlpha != 0) {
                    var27 = super.clips.currentFaceAlpha;
                    var28 = 256 - super.clips.currentFaceAlpha;
            ...
            } else if (super.clips.currentFaceAlpha != 0) {
                var27 = super.clips.currentFaceAlpha;
                var28 = 256 - super.clips.currentFaceAlpha;
