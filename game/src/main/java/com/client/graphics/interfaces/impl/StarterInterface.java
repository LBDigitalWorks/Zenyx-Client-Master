...
public class StarterInterface extends RSInterface {
    ...
    private String[] GAME_MODES = {
            ...
            "Legendary Mode\\nStandard mode with a 1x experience rate.\\nReceives 10% drop rate boost.",
            "Legendary Ironman\\nAn Iron Man cannot trade, stake, receive PK loot, \\nor scavenge dropped items.\\nwith a 1x experience rate and 12% drop rate boost.",
            "Legendary Hardcore Ironman\\nA hardcore variant of the standard ironman mode\\nwith a 1x experience rate and 12% drop rate boost.\\nConverts to Legendary ironman on death.",
            "Wilderness Man\\nA Wilderness locked mode\\nwith a standard experience rate and 8% drop rate boost.\\nIronman game play but wildy locked.",
