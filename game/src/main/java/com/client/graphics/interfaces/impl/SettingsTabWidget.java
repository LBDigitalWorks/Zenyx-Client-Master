...
public class SettingsTabWidget extends RSInterface {
    ...
    private static final Logger log = LoggerFactory.getLogger(SettingsTabWidget.class);
	...
	public static void audioSettings(RSInterface audio, TextDrawingArea[] tda) {
		...
		soundVolumeSlider = slider(SOUND_SLIDER, 0, 127, 37, 54, 4);
		Interfaces.addSprite3(42535, 53);
		areaSoundVolumeSlider = slider(AREA_SOUND_SLIDER, 0, 127, 37, 54, 5);
