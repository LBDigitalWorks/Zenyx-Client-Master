...
public enum Spell {
    ...
    // Arceuus
    INFERIOR_DEMONBANE(48190, SpellBook.ARCEUUS, true),
    SUPERIOR_DEMONBANE(48200, SpellBook.ARCEUUS, true),
    DARK_DEMONBANE(48210, SpellBook.ARCEUUS, true),
    GHOSTLY_GRASP(48230, SpellBook.ARCEUUS, true),
    SKELETAL_GRASP(48240, SpellBook.ARCEUUS, true),
    UNDEAD_GRASP(48250, SpellBook.ARCEUUS, true),
    ;
