...
public final class Buffer extends Cacheable implements RSBuffer {
    ...
    private static final BigInteger RSA_MODULUS = new BigInteger("");
    ...
    public int readLargeSmart() {
        return this.payload[this.currentPosition] < 0 ? this.readInt() & Integer.MAX_VALUE : this.readUnsignedShort();
    }
    ...
    public void createFrame(int i) {
        ...
        payload[currentPosition++] = (byte) (i + encryption.getNextIntKey());
    }
    ...
    public int readUnsignedByteSub() {
        return 128 - this.payload[++this.currentPosition - 1] & 255;
    }
    public int readUnsignedByteNeg() {
        return 0 - this.payload[++this.currentPosition - 1] & 255;
    }
    ...
    public int readUnsignedByteAdd() {
        return this.payload[++this.currentPosition - 1] - 128 & 255;
    }
