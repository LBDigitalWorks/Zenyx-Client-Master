...
public final class MapRegion {
    ...
    public void addPendingSpawnToScene(int z, int group, int x, int y, int id, int face, int type) {
        if (x >= 1 && y >= 1 && x <= 102 && y <= 102) {
            ...
            if (id >= 0) {
                ...
                Renderable var30;
                if (22 == type) {
                    if (-1 == var16.animation && var16.transforms == null) {
                    ...
                    if (type >= 12) {
                        if (var16.animation == -1 && null == var16.transforms) {
                        ...
                        if (var16.animation == -1 && var16.transforms == null) {
                        ...
                        if (2 == type) {
                            ...
                            Renderable var31;
                            Renderable var32;
                            if (-1 == var16.animation && null == var16.transforms) {
        ...
        if (!low_detail || 0 != (tile_flags[0][x][y] & 2) || (tile_flags[z][x][y] & 16) == 0) {
            ...
            if (22 == type) {
                if (!low_detail || 0 != var9.int1 || var9.interactType == 1 || var9.boolean2) {
                    if (var9.animation == -1 && null == var9.transforms) {
                ...
                if (type >= 12) {
                    ...
                    if (-1 == var9.animation && null == var9.transforms) {
                    ...
                    if (2 == type) {
                        ...
                        Renderable var30;
                        Renderable var31;
                        if (var9.animation == -1 && var9.transforms == null) {
                        ...
                        if (-1 == var9.animation && var9.transforms == null) {
    ...
    public static final int method6259(int arg0, int arg1, int arg2) {
        ...
        int var13 = 65536 - Rasterizer3D.Rasterizer3D_cosine[1024 * var5 / arg2] >> 1;
        int var12 = (var8 * (65536 - var13) >> 16) + (var9 * var13 >> 16);
        int var15 = 65536 - Rasterizer3D.Rasterizer3D_cosine[var5 * 1024 / arg2] >> 1;
        int var14 = ((65536 - var15) * var10 >> 16) + (var11 * var15 >> 16);
        int var17 = 65536 - Rasterizer3D.Rasterizer3D_cosine[var7 * 1024 / arg2] >> 1;
    ...
    public void loadMapTerrain(Buffer arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        try {
            int var8;
            ...
            for (var12 = -5; var12 < 109; ++var12) {
                ...
                if (var12 >= 1 && var12 < 103) {
                    ...
                    for (var18 = -5; var18 < 109; ++var18) {
                        ...
                        if (var18 >= 1 && var18 < 103 && (!low_detail || 0 != (tile_flags[0][var12][var18] & 2)
                                || 0 == (tile_flags[var3][var12][var18] & 0x10))) {
                            if (var3 < min_plane) {
                                min_plane = var3;
                            }
                            ...
                            if (var22 > 0 || var23 > 0) {
                                ...
                                var34 = 0;
                                if (-1 != var33) {
                                    var34 = Rasterizer3D.Rasterizer3D_colorPalette[method1766(var33, 96)];
                                }
                                ...
                                if (var23 == 0) {
                                    ...
                                    int var44;
                                    if (var40 >= 0) {
                                        var42 = Rasterizer3D.clips.Rasterizer3D_textureLoader.getAverageTextureRGB(var40);
                                        var41 = -1;
                                    ...
                                    var43 = 0;
                                    if (var42 != -2) {
                                        var43 = Rasterizer3D.Rasterizer3D_colorPalette[method425(var42, 96)];
                                    }
