    ...
    void decodeIndex(byte[] payload) {
        ...
        if (protocol >= 5 && protocol <= 7) {
            ...
            if (var8) {
                ...
                this.field4990 = lastGroupId + 1;
                this.groupCrcs = new int[field4990];
                this.groupVersions = new int[field4990];
                this.fileCounts = new int[field4990];
                this.fileIds = new int[field4990][];
                this.groups = new Object[field4990];
                this.files = new Object[field4990][];
                if (var7) {
                    this.groupNameHashes = new int[field4990];
                ...
                if (var9) {
                    this.field5005 = new int[field4990];
                    this.field5000 = new int[field4990];

                    for (int index = 0; index < this.groupCount; ++index) {
                        this.field5005[this.groupIds[index]] = buffer.readInt();
                        this.field5000[this.groupIds[index]] = buffer.readInt();
                    }
                }
                for (int index = 0; index < this.groupCount; ++index) {
                ...
                if (protocol >= 7) {
                    for (int index = 0; index < this.groupCount; ++index) {
                        this.fileCounts[this.groupIds[index]] = buffer.readLargeSmart();
                    }
                    ...
                    for (int var13 = 0; var13 < this.groupCount; ++var13) {
                        this.fileCounts[this.groupIds[var13]] = buffer.readUnsignedShort();
                    }
                ...
                if (var7) {
                    ...
                    for (int index = 0; index < this.groupCount; ++index) {
                        int var15 = this.groupIds[index];
                        int var11 = this.fileCounts[var15];
                        this.fileNameHashes[var15] = new int[this.files[var15].length];
                        Arrays.fill(this.fileNameHashes[var15], -1);

                        for (int var12 = 0; var12 < var11; ++var12) {
                            int var17 = this.fileIds[var15] != null ? this.fileIds[var15][var12] : var12;
                            this.fileNameHashes[var15][var17] = buffer.readInt();
                        }

                        this.fileNameHashTables[var15] = new IntHashTable(this.fileNameHashes[var15]);
                    }
                }
            }
        } else {
    ...
    public static byte[] decompress(byte[] compressedData) {
        ...
        if (compressedSize < 0 || AbstractArchive.maxSize != 0 && compressedSize > AbstractArchive.maxSize) {
            ...
            if (uncompressedSize >= 0 && (AbstractArchive.maxSize == 0 || uncompressedSize <= AbstractArchive.maxSize)) {
                ...
                log.error("Invalid data length: {}", compressedData.length);
                throw new IllegalArgumentException("Invalid compressed data");
            }
        }
    }
