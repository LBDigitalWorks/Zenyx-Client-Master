...
public final class SpotAnimation extends DualNode implements RSSpotAnimationDefinition {
    ...
    public final Model getModel(int var1) {
        ...
        if (this.sequence != -1 && var1 != -1) {
            SequenceDefinition definition = SequenceDefinition.get(this.sequence);
            if (definition == null) {
                var3 = var2.toSharedSpotAnimationModel(true);
            } else {
                try {
                    var3 = definition.transformSpotAnimationModel(var2, var1);
    ...
    public final Model createModel() {
        ...
        if (var1 == null) {
            ModelData var2 = ModelData.getModel(this.modelId);
            if (var2 == null) {
                return null;
            }
