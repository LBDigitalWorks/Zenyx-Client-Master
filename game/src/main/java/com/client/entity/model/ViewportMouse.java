...
public class ViewportMouse {
    ...
    public static void method737() {
        if (!ViewportMouse.inbounds) {
            ...
            byte var4 = 50;
            short var5 = 3500;
            int var6 = (ViewportMouse.ViewportMouse_x - Clips.getClipMidX()) * var4 / Clips.get3dZoom();
            int var7 = (ViewportMouse.ViewportMouse_y - Clips.getClipMidY()) * var4 / Clips.get3dZoom();
            int var8 = (ViewportMouse.ViewportMouse_x - Clips.getClipMidX()) * var5 / Clips.get3dZoom();
            int var9 = (ViewportMouse.ViewportMouse_y - Clips.getClipMidY()) * var5 / Clips.get3dZoom();
    ...
    public static void setEntity(long var0) {
        if (ViewportMouse.entityCount >= entityTags.length) {
            return;
        }
