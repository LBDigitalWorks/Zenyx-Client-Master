...
public class ModelData extends Renderable implements RSModelData {
    ...
    public ModelData(ModelData[] var1, int var2) {
        ...
        for (var11 = 0; var11 < var2; ++var11) {
            ...
            if (var12 != null) {
                ...
                var9 |= var12.field2713 != null;
                var10 |= var12.field2718 != null;
            }
        }
        ...
        if (var9) {
            this.field2713 = new int[this.verticesCount][];
            this.field2714 = new int[this.verticesCount][];
        }

        if (var10) {
            this.field2718 = new byte[this.faceCount];
        }
        ...
        for (var11 = 0; var11 < var2; ++var11) {
            ...
            if (var12 != null) {
                ...
                for (var13 = 0; var13 < var12.faceCount; ++var13) {
                    ...
                    if (var10 && var12.field2718 != null) {
                        this.field2718[this.faceCount] = var12.field2718[var13];
                    }

                    this.faceColors[this.faceCount] = var12.faceColors[var13];
                    this.indices1[this.faceCount] = this.method5269(var12, var12.indices1[var13]);
                    this.indices2[this.faceCount] = this.method5269(var12, var12.indices2[var13]);
                    this.indices3[this.faceCount] = this.method5269(var12, var12.indices3[var13]);
                    ++this.faceCount;
                }
                ...
                for (var13 = 0; var13 < var12.textureTriangleCount; ++var13) {
                    ...
                    if (var14 == 0) {
                        this.texTriangleX[this.textureTriangleCount] = (short)this.method5269(var12, var12.texTriangleX[var13]);
                        this.texTriangleY[this.textureTriangleCount] = (short)this.method5269(var12, var12.texTriangleY[var13]);
                        this.texTriangleZ[this.textureTriangleCount] = (short)this.method5269(var12, var12.texTriangleZ[var13]);
                    }
    ...
    ModelData(byte[] var1, int ModelId) {
        ...
        if (IntStream.of(models662).anyMatch(x -> x == ModelId)) {
            if (faceRenderTypes != null) {
                Arrays.fill(faceRenderTypes, (byte) 10);
            }
            scale(32, 32, 32);
           translate(0, 6, 0);
        }
    }
    public static final int[] models662 = {
            65270, 65297, 65316, 65273, 65292, 65310
    };
    public ModelData(ModelData var1, boolean var2, boolean var3, boolean var4, boolean var5) {
        ...
        this.field2713 = var1.field2713;
        this.field2714 = var1.field2714;
        this.ambient = var1.ambient;
        this.contrast = var1.contrast;
        this.field2718 = var1.field2718;
    }
    ...
    void decodeType3(byte[] var1) {
        ...
        var2.currentPosition = var1.length - 26;
        ...
        var2.currentPosition = var11;
        var3.currentPosition = var40;
        var4.currentPosition = var41;
        var5.currentPosition = var42;
        var6.currentPosition = var34;
        int var50 = 0;
        int var51 = 0;
        int var52 = 0;
        ...
        if (var18 == 1) {
            for(var53 = 0; var53 < var9; ++var53) {
                ...
                this.field2713[var53] = new int[var54];
                this.field2714[var53] = new int[var54];

                for(var55 = 0; var55 < var54; ++var55) {
                    this.field2713[var53][var55] = var6.readUnsignedByte();
                    this.field2714[var53][var55] = var6.readUnsignedByte();
                }
            }
        }

        var2.currentPosition = var39;
        var3.currentPosition = var30;
        var4.currentPosition = var32;
        var5.currentPosition = var35;
        var6.currentPosition = var33;
        var7.currentPosition = var37;
        var8.currentPosition = var38;
        ...
        var2.currentPosition = var36;
        var3.currentPosition = var31;
        var53 = 0;
        var54 = 0;
        var55 = 0;
        var56 = 0;
        ...
        var2.currentPosition = var43;
        var3.currentPosition = var44;
        var4.currentPosition = var45;
        var5.currentPosition = var46;
        var6.currentPosition = var47;
        var7.currentPosition = var48;
        ...
        if (var60) {
            this.field2718 = new byte[var10];

            for (int var59 = 0; var59 < var10; ++var59) {
                this.field2718[var59] = var2.readByte();
            }
        }
    }
    ...
    void decodeType2(byte[] var1) {
        ...
        Buffer var7 = new Buffer(var1);
        Buffer var8 = new Buffer(var1);
        var4.currentPosition = var1.length - 23;
        ...
        this.faceColors = new short[var10];
        var4.currentPosition = var24;
        var5.currentPosition = var34;
        var6.currentPosition = var35;
        var7.currentPosition = var36;
        var8.currentPosition = var29;
        int var37 = 0;
        int var38 = 0;
        int var39 = 0;
        ...
        if (var17 == 1) {
            for(var40 = 0; var40 < var9; ++var40) {
                ...
                this.field2713[var40] = new int[var41];
                this.field2714[var40] = new int[var41];

                for(var42 = 0; var42 < var41; ++var42) {
                    this.field2713[var40][var42] = var8.readUnsignedByte();
                    this.field2714[var40][var42] = var8.readUnsignedByte();
                }
            }
        }

        var4.currentPosition = var32;
        var5.currentPosition = var28;
        var6.currentPosition = var26;
        var7.currentPosition = var30;
        var8.currentPosition = var27;
        ...
        var4.currentPosition = var31;
        var5.currentPosition = var25;
        var40 = 0;
        var41 = 0;
        var42 = 0;
        var43 = 0;
    ...
    void decodeType1(byte[] var1) {
        ...
        Buffer var7 = new Buffer(var1);
        Buffer var8 = new Buffer(var1);
        var2.currentPosition = var1.length - 23;
        int var9 = var2.readUShort();
        int var10 = var2.readUShort();
        int var11 = var2.readUnsignedByte();
        int var12 = var2.readUnsignedByte();
        ...
        var2.currentPosition = var11;
        var3.currentPosition = var38;
        var4.currentPosition = var39;
        var5.currentPosition = var40;
        var6.currentPosition = var32;
        int var48 = 0;
        int var49 = 0;
        int var50 = 0;
        ...
        var2.currentPosition = var37;
        var3.currentPosition = var28;
        var4.currentPosition = var30;
        var5.currentPosition = var33;
        var6.currentPosition = var31;
        var7.currentPosition = var35;
        var8.currentPosition = var36;
        ...
        var2.currentPosition = var34;
        var3.currentPosition = var29;
        var51 = 0;
        var52 = 0;
        var53 = 0;
        var54 = 0;
        ...
        var2.currentPosition = var41;
        var3.currentPosition = var42;
        var4.currentPosition = var43;
        var5.currentPosition = var44;
        var6.currentPosition = var45;
        var7.currentPosition = var46;
    ...
    void decodeOldFormat(byte[] var1) {
        ...
        Buffer var7 = new Buffer(var1);
        Buffer var8 = new Buffer(var1);
        var4.currentPosition = var1.length - 18;
        int var9 = var4.readUShort();
        int var10 = var4.readUShort();
        int var11 = var4.readUnsignedByte();
        int var12 = var4.readUnsignedByte();
        ...
        this.faceColors = new short[var10];
        var4.currentPosition = var22;
        var5.currentPosition = var32;
        var6.currentPosition = var33;
        var7.currentPosition = var21;
        var8.currentPosition = var27;
        int var35 = 0;
        int var36 = 0;
        int var37 = 0;
        ...
        var4.currentPosition = var30;
        var5.currentPosition = var26;
        var6.currentPosition = var24;
        var7.currentPosition = var28;
        var8.currentPosition = var25;
        ...
        var4.currentPosition = var29;
        var5.currentPosition = var23;
        var38 = 0;
        var39 = 0;
        var40 = 0;
        var41 = 0;
    ...
    final int method5269(ModelData var1, int var2) {
        int var3 = -1;
        ...
        if (var3 == -1) {
            ...
            if (var1.field2713 != null) {
                this.field2713[this.verticesCount] = var1.field2713[var2];
                this.field2714[this.verticesCount] = var1.field2714[var2];
            }
    ...
    public final Model toModel(int var1, int var2, int var3, int var4, int var5) {
        ...
        var8.faceBias = this.field2718;
        return var8;
    }
    public static ModelData ModelData_get(AbstractArchive var0, int var1, int var2) {
        byte[] var3 = var0.takeFile(var1, var2);
        return var3 == null ? null : new ModelData(var3, var1);
    }
    public static ModelData getModel(int var1) {
        byte[] var3 = Js5List.models.takeFile(var1, 0);
        return var3 == null ? null : new ModelData(var3, var1);
    }

    public static ModelData get(int var1, int var2) {
        byte[] var3 = Js5List.models.takeFile(var1, var2);
        return var3 == null ? null : new ModelData(var3, var1);
    }

    public static void method4253(ModelData var0, ModelData var1, int var2, int var3, int var4, boolean var5) {
    ...
    public RSModelData newModelData(net.runelite.api.ModelData var1, boolean var2, boolean var3, boolean var4, boolean var5) {
        return new ModelData((ModelData) var1,var2,var3,var4,var5);
    }
